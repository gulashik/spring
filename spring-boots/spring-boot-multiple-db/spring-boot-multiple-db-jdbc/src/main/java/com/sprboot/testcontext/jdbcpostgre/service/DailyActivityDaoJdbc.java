...
public class DailyActivityDaoJdbc {
    ...
    private final JdbcOperations jdbc; // todo будет привязка основного data source с @Primary

    private final NamedParameterJdbcTemplate namedJdbc; // todo будет привязка основного data source с @Primary
