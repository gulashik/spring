...
// todo сами создаём нужный набор бинов для JPA
//  т.к. Автоконфигурация срабатывает если таких бинов нету
//  (аннотация @ConditionalOnMissingBean например: JpaBaseConfiguration)
@Configuration
...
public class PrimaryDbConfig {
    ...
    @Primary // todo аннотация @Primary для основного data source
    @Bean
