...
public class MergeExample {
    ...
    private static void mergerExample() {
        ...
        // todo merge - выполняет объединение асинхронно, то есть элементы из разных источников могут приходить в любом порядке.
        Disposable disposable = Flux.merge(flux1, flux2)
