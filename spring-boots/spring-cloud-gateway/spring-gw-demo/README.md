...
Этот проект служит всесторонним образовательным ресурсом для изучения Spring Cloud Gateway, демонстрируя принципы работы "от простого к сложному" и покрывая все основные возможности современного API Gateway.
...
Spring Cloud Gateway построен на основе:

- **Spring WebFlux** - неблокирующий веб-стек
- **Project Reactor** - реактивное программирование
- **Netty** - асинхронный сетевой сервер
- **Spring Cloud** - интеграция с микросервисной экосистемой
